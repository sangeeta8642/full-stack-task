...
export const addBoard = createAction('[boards] Add Board');
...
export const deleteBoardSuccess = createAction('[boards] Delete Board Success', props<{ id: number, board: BoardsInterface }>());
