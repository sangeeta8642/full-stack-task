...
export const addSprint = createAction('[sprints] Add Sprint');
...
export const updateSprint = createAction('[sprints] Update Sprint');
...
export const deleteSprint = createAction('[sprints] Delete Sprint');
