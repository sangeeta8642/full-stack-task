...
export const addRelease = createAction('[releases] Add Release');
...
export const updateRelease = createAction('[releases] Update Release');
...
export const deleteRelease = createAction('[releases] Delete Release');
